public class CountGoodNumber {
        ...
        long power(long x,long y){// this method computes pow(x,y) in O(logn) using divide & conquer
            long temp;
        ...
        public static void main(String[] args) {
            int n = 50; // Test with n = 50
            int count = countGoodNumbers(n);
            System.out.println("The number of good numbers between 1 and " + n + " is " + count);
        }
